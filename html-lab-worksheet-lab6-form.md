...
<body>
    ...
    <form action="/register" method="post">
        ...
        <fieldset>
            ...
            <div class="form-group">
                <label for="firstName">ชื่อ:</label>
                <input type="text" id="firstName" name="firstName" value="ธีธัช" required>
            </div>
    
            <div class="form-group">
                <label for="lastName">นามสกุล:</label>
                <input type="text" id="lastName" name="lastName" value="คัคคนัมพร" required>
            </div>
    
            <div class="form-group">
                <label for="birthdate">วันเกิด:</label>
                <input type="date" id="birthdate" name="birthdate" value="2549-08-04" required>
            </div>
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <select id="major" name="major" required>
                    <option value="">เลือกสาขาวิชา</option>
                    <option value="computer-tech">สาขาเทคโนโลยีคอมพิวเตอร์</option>
                </select> <span class="required-mark">*</span>
            </div>
        ...
        <fieldset>
            ...
            <div class="form-group">
                <label>ความสนใจ:</label>
                <input type="checkbox" id="sport" name="interests" value="sport" checked>
                <label for="sport">กีฬา</label>
...
![alt text](<สกรีนช็อต 2026-02-18 113525.png>)
