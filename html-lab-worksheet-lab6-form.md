        ...
        <form action="/register" method="post">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <span class="required-mark">*</span>
                    <p id="fileError" style="color: red; display: none;">ขนาดไฟล์ต้องไม่เกิน 2MB</p>
                </div>
            </fieldset>
...
<fieldset>
    ...
    <div class="form-group">
        ...
        <input type="text" id="password" name="text" required minlength="6">
    </div>
    <div class="form-group">
        ...
        errorText.style.display = 'none';
            ...
            <fieldset>
                ...
                <div class="form-group">
                    <label>ความสนใจ:</label>
                    <input type="checkbox" id="sport" name="interests" value="sport">
                    <label for="sport">สินค้าอุปโภคบริโภค</label>
                    <input type="checkbox" id="music" name="interests" value="music">
                    <label for="music">สินค้าอิเล็กทรอนิกส์</label>
                    <input type="checkbox" id="art" name="interests" value="art">
                    <label for="art"> เสื้อผ้าและแฟชั่น</label>
                    <input type="checkbox" id="tech" name="interests" value="tech">
                    <label for="tech">เฟอร์นิเจอร์และของแต่งบ้าน</label>
                    <input type="checkbox" id="tech" name="interests" value="tech">
                    <label for="tech">หนังสือและสื่อบันเทิง</label>
            </fieldset>
