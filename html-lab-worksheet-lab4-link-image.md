...
<head>
    ...
    <style>
        ...
        .gallery figure { margin:0; width:220px; text-align:center; }
        .gallery img { display:block; width:100%; height:auto; }
        .top-btn { display:inline-block; margin-top:16px; }
    </style>
</head>
<body>
    <nav>
    ...
    <section id="gallery">
        ...
        <div class="gallery">
            <figure>
                <a href="images/gallery/adi1.png">
                    <img src="images/gallery/adi1.png" alt="สินค้า 1">
                </a>
                <figcaption>รองเท้า Handball Spezial</figcaption>
            </figure>

            <figure>
                <a href="images/gallery/adi2.png">
                    <img src="images/gallery/adi2.png" alt="สินค้า 2">
                </a>
                <figcaption>รองเท้า Equipment Agravic</figcaption>
            </figure>

            <figure>
                <a href="images/gallery/adi3.png">
                    <img src="images/gallery/adi3.png" alt="สินค้า 3">
                </a>
                <figcaption>รองเท้า Japan</figcaption>
            </figure>

            <figure>
                <a href="images/gallery/adi4.png">
                    <img src="images/gallery/adi4.png" alt="สินค้า 4">
                </a>
                <figcaption>รองเท้า UB x FORTNITE UB1.0</figcaption>
            </figure>
        </div>

        <p><a class="top-btn" href="#top">กลับด้านบน</a></p>
    </section>

    <footer>
        <p>ติดต่อ: <a href="mailto:contact@example.com">contact@example.com</a></p>
    </footer>
</body>
</html>
```
