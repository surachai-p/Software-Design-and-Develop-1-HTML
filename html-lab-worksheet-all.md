...
<p>มัธยมปลายจบจากโรงเรียนพนมไพรวิทยาคาร ปัจจุบันกำลังศึกษาอยู่ที่สถาบันเทคโนโลยีพระจอมเกล้าเจ้าคุณทหารลาดกระบัง</p>
<p>งานอดิเรกคือ การทำอาหารและการเล่นกีฬา <strong>เป้าหมายในอนาคตคืออยากเป็นครูสอนเด็กๆได้ตามความรู้ที่เรียนมา</strong> และ <em>อยากเลี้ยงพ่อกับแม่ให้ได้</em></p>
<p>ขึ้นบรรทัดใหม่<br>ด้วย br</p>
<hr>
<pre>
    อยากได้เกรดAทุกวิชา
...
```
- ภาพผลลัพธ์:
![image](https://github.com/user-attachments/assets/ee2d6075-e80c-4db6-9df9-572af9081c13)
