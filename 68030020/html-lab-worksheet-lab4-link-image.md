...
<body>
    <!-- โลโก้บริษัท -->
    <h1 id="top">ร้านขนมไทย</h1>
    <img src="imges/ขนมไทยหลากหลายชนิดวางบนใบตอง-768x512.jpg" 
         alt="โลโก้บริษัท" 
         width="100">
    ...
    <figure>
        <a href="gallery/2979c50de28b4137a3c0224591db4af5.webp" target="_blank">
            <img src="gallery/2979c50de28b4137a3c0224591db4af5.webp" 
                 alt="สินค้าชิ้นที่ 1" 
                 width="200" height="100">
        </a>
        <figcaption>-ขนมโคเสียบไม้</figcaption>
    </figure>

    <figure>
        <a href="gallery/images (1).jpg" target="_blank">
            <img src="gallery/images (1).jpg" 
                 alt="สินค้าชิ้นที่ 2" 
                 width="200" height="100">
        </a>
        <figcaption>ขนมเต่าแดง</figcaption>
    </figure>

    <figure>
        <a href="gallery/ขนมชั้นใบเตย-2018-1.jpg" target="_blank">
            <img src="gallery/ขนมชั้นใบเตย-2018-1.jpg" 
                 alt="สินค้าชิ้นที่ 3" 
                 width="200" height="100">
        </a>
        <figcaption>ขนมชั้นใบเตย</figcaption>
    </figure>

 
    <figure>
        <a href="gallery/kai8.jpg" target="_blank">
            <img src="gallery/kai8.jpg" 
                 alt="สินค้าชิ้นที่ 4" 
                 width="200" height="100">
        </a>
        <figcaption>ขนมไข่</figcaption>
    </figure>
...
```
- ภาพผลลัพธ์:
[![alt text](<Screenshot 2026-02-17 234111.png>)]
