...
<body>
    ...
    <form action="/signup" method="post" enctype="multipart/form-data">
        ...
        <fieldset>
            ...
            <label for="firstName">ชื่อ:<span class="required-mark">*</span></label>
            <input type="text" id="firstName" name="firstName" required><br><br>

            <label for="lastName">นามสกุล:<span class="required-mark">*</span></label>
            <input type="text" id="lastName" name="lastName" required><br><br>

            <label for="birthdate">วันเกิด:<span class="required-mark">*</span></label>
        ...
        <fieldset>
            ...
            <label for="address">ที่อยู่จัดส่ง:<span class="required-mark">*</span></label><br>
        ...
        <fieldset>
            ...
            <label for="profilePic">อัพโหลดรูปภาพ:<span class="required-mark">*</span></label>
            <input type="file" id="profilePic" name="profilePic" accept="image/*" required>
        </fieldset>

        <!-- รหัสผ่าน -->
        <fieldset>
            <legend>การตั้งรหัสผ่าน</legend>
        ...
        <fieldset>
            ...
            <input type="checkbox" id="agree" name="agree" required>
            <label for="agree">ฉันยอมรับเงื่อนไขการใช้งาน<span class="required-mark">*</span></label>
        </fieldset>
