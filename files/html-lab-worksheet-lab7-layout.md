...
### บันทึกผลการทดลอง
จากที่ผมได้ทำความเข้าใจโดยการทำ LAB และตรวจสอบความเข้าใจกับ AI สิ่งที่ผมเข้าใจ คือ หากไม่ได้ใช้สิ่งที่เรียนใน LAB7 หน้าเว็บก็ยังสามารถทำงานได้เหมือนเดิม แต่ถ้าใช้ จะทำให้ระบบเบื้องหลังทำงานง่ายและเร็วขึ้น ภาระการทำงานลดน้อยลง รวมถึงโครงสร้างเป็นระเบียบเรียบร้อยและดูง่าย

![screenshot-lab7](../images/screenshots/lab7.png)
